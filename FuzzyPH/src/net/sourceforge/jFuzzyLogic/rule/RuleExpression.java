...
public class RuleExpression extends FclObject implements Iterable<Variable>, CompileCpp {
    ...
    public void setTerm1(FclObject term1) {
        if (!isValidTerm(term1))
            throw new RuntimeException("Invalid object for term1. Only 'RuleTerm' or 'RuleExpression' are accepted. Class: " + term1.getClass().getName());
        this.term1 = term1;
    }
    ...
    public void setTerm2(FclObject term2) {
        if (!isValidTerm(term2))
            throw new RuntimeException("Invalid object for term2. Only 'RuleTerm' or 'RuleExpression' are accepted. Class: " + term2.getClass().getName());
        this.term2 = term2;
    }
