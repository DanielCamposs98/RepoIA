...
public class JFuzzyChartImpl extends JFuzzyChart {
    ...
    protected JFreeChart chartCreate(Variable var, boolean showIt) {
        ...
        JFreeChart chart;
        if (!discrete)
            chart = ChartFactory.createXYAreaChart(var.getName(), "x", "Membership", xyDataset, PlotOrientation.VERTICAL, true, true, false);
        else
            chart = ChartFactory.createScatterPlot(var.getName(), "x", "Membership", xyDataset, PlotOrientation.VERTICAL, true, true, false);
