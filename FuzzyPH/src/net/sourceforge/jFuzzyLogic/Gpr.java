...
public class Gpr {
    ...
    public static boolean parseBooleanSafe(String s) {
        ...
        try {
            if (s.equalsIgnoreCase("true") || s.equalsIgnoreCase("on") || s.equalsIgnoreCase("yes") || s.equalsIgnoreCase("si") || s.equalsIgnoreCase("oui") || s.equalsIgnoreCase("ja") || s.equalsIgnoreCase("da"))
                return true;
            return false;
        } catch (Exception e) {
            return false;
